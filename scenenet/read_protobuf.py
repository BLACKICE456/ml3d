...
data_root_path = 'val'
protobuf_path = 'scenenet_rgbd_val.pb'
...
if __name__ == '__main__':
    ...
    for traj in trajectories.trajectories:
        ...
        '''
        The instances attribute of trajectories contains all of the 
information
        about the different instances.  The instance.instance_id attribute 
provides
        correspondences with the rendered instance.png files.  I.e. for a 
given
        trajectory, if a pixel is of value 1, the information about that 
instance,
        such as its type, semantic class, and wordnet id, is stored here.
        For more information about the exact information available refer 
to the
        scenenet.proto file.
        '''
        ...
        print('Render path:{0}'.format(traj.render_path))
        '''
        The views attribute of trajectories contains all of the 
information
